...
class LoginGUI extends JFrame implements ActionListener {
	...
	private JLabel NickName_Label = new JLabel("닉네임 입력");
	private JLabel Password_Label = new JLabel("비밀번호 입력");
	private JLabel Port_Label = new JLabel("포트 입력(0 ~ 65535)");
	//ip
	private JLabel IPAddress_Label = new JLabel("들어갈 방 번호 입력");
	private JButton Login_GUI_Button = new JButton("접속");
	private JButton GoSignUp_GUI_Button = new JButton("회원가입");
	...
	public LoginGUI() {
		...
		Login_GUIPanel.add(Password_Label);
		Login_GUIPanel.add(Password_Text);
